...
export default function LandingPage() {
  ...
  return (
    <>
      <div className={`min-h-screen bg-[#F8FAFC] text-[#1B254B] font-sans overflow-x-hidden transition-all duration-300 ${isLoginModalOpen ? 'blur-sm pointer-events-none select-none' : ''}`}>
        {/* Premium Top Navbar */}
