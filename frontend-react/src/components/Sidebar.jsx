    ...
    <aside className={`bg-white border-r border-[#E9EDF7] w-64 h-full flex-shrink-0 flex flex-col transition-transform duration-300 z-30 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} absolute md:relative`}>
      ...
      <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        >
          {({ isActive }) => (
            <>
              <div className="flex items-center gap-3">
                <svg className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {role === 'admin' && (
          <>
            {/* MANAJEMEN PENGGUNA */}
            <div className="text-xs font-semibold text-[#A3AED0] uppercase tracking-widest px-3 pt-4 mb-2">Manajemen Pengguna</div>
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiUser className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiUpload className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiUsers className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            {/* MANAJEMEN SEKOLAH */}
            <div className="text-xs font-semibold text-[#A3AED0] uppercase tracking-widest px-3 pt-4 mb-2">Manajemen Sekolah</div>
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiLayers className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiGrid className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiCalendar className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            {/* LAPORAN & ANALITIK */}
            <div className="text-xs font-semibold text-[#A3AED0] uppercase tracking-widest px-3 pt-4 mb-2">Laporan & Analitik</div>
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiActivity className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiFileText className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            {/* KONFIGURASI SISTEM */}
            <div className="text-xs font-semibold text-[#A3AED0] uppercase tracking-widest px-3 pt-4 mb-2">Konfigurasi Sistem</div>
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiSettings className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <div className="flex items-center gap-3">
                    <FiShield className={`w-5 h-5 ${isActive ? 'text-[#4318FF]' : 'text-[#A3AED0]'}`} />
      ...
      <div className="p-4 border-t border-[#E9EDF7] bg-white">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-[#FFF5F5] border border-[#FDE8E8] hover:bg-[#FDE8E8] text-[#E31A1A] font-semibold rounded-xl text-sm transition-all duration-200 cursor-pointer"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
